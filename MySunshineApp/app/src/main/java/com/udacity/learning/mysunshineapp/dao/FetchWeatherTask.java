...
import com.udacity.learning.mysunshineapp.BuildConfig;
import com.udacity.learning.mysunshineapp.R;
import com.udacity.learning.mysunshineapp.dao.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.unit_pref_key),
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locCursor != null) {
            if (locCursor.moveToFirst()) {
                ...
                locationID = locCursor.getLong(locIDIndex);
            } else {
                ContentValues values = new ContentValues();
                values.put(WeatherContract.LocationEntry.COLUMN_CITY_NAME, cityName);
                values.put(WeatherContract.LocationEntry.COLUMN_LOC_SETTING, locationSetting);
